    ...
    <div id="main">
      ...
      <div className="w-full h-screen absolute top-0 left-0 bg-white/50">
        <div className="max-w-[700px] m-auto h-full w-full flex flex-col justify-center lg:items-start items-center">
          <h1 className="smm:text-3xl sm:text-5xl text-4xl text-gray-800">I'm Viacheslav Babenko</h1>
          <h2 className="flex center smm:text-2xl sm:text-3xl text-2xl pt-4 text-gray-800">
            I'm a
            <TypeAnimation
              sequence={[
                "Developer",
